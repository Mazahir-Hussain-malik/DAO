      ...
      <div className=" bg-black w-full pt-5 px-4 sm:px-6 md:px-8 lg:ps-72">
        <header>
          <div className="w-full bg-[#7A7C9B] rounded-md flex flex-col items-center justify-center px-[70px] py-[20px]">
            <h2
              className="text-[#D9D2FF] text-4xl font-normal"
              style={{
            ...
            <p
              className="font-normal text-sm my-4 text-[#fff]"
              style={{
                textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)",
              }}
            >
              To start earning you need to select and buy an NFT. Please click
              on the NFT of your choosing. The NFT will determine the multiplier
              you will receive.
            </p>
            <h3
              className="font-semibold text-xl text-[#fff]"
              style={{
                textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)",
              }}
            >
              To start, select your NFT level below
            </h3>
          </div>
          <div className="md:w-[80%] w-full mx-auto  my-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
              {CardsArray.map((items, id) => (
                <div
                  key={id}
                  className="bg-[#1E283D]  relative py-[6px] px-2 rounded-[10px] flex flex-col justify-center items-center"
                >
                  <img
                    src={items.Icon}
                  ...
                  <img
                    ...
                    alt="gif loading"
                  />
                  <p className="my-[18px] text-[#D9D2FF] text-xl font-medium text-center">
                    {items.content}
                  </p>
                  <span className="text-[#0BDF0E] text-xl font-med ium bg-[#121E2A] rounded-lg px-10 py-1">
                    {items.number}
                  </span>
                </div>
              ))}
          ...
          <div className="">
            <div className="bg-[#4E527D] py-4 text-center rounded-md ">
              <h2
                className="font-semibold text-xl my-2 text-[#fff]"
                style={{
                  textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)",
                }}
              >
                As a bonus we will gift you 10% of the NFT value in tokens.
              </h2>
              <p
                className="font-normal text-base my-1 text-[#fff]"
                style={{
                  textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)",
                }}
              >
                <span className="text-[#C90000]"> NOTE :</span> &nbsp;
                &nbsp;&nbsp; To increase your outcome, add additional tokens to
                your NFT
              </p>
            </div>
            <div className="md:w-[70%] w-[90%] mx-auto md:py-9 py-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
              <div
                className="text-center py-4 px-[22px] text-xl font-medium rounded-xl"
                style={{
                  background:
                    "linear-gradient(72deg, rgba(33, 231, 134, 0.60) 2.9%, rgba(48, 131, 49, 0.60) 100%)",
                }}
              >
              ...
              <div className="text-center  py-4 px-[22px] text-xl font-medium rounded-xl bg-[#212F45]">
                <h2 className="text-white">
                  204,600 <br /> <span className="text-[#0BDF0E]"> USDT</span>{" "}
                </h2>
              </div>
              <div className="text-center  py-4 px-[22px] text-xl font-medium rounded-xl bg-[#212F45]">
                <h2 className="text-white">
              ...
              <div className="text-center  py-4 px-[22px] text-xl font-medium rounded-xl bg-[#212F45]">
                <h2 className="text-white">
                  102,300 <br /> <span className="text-[#0BDF0E]"> USDT</span>{" "}
                </h2>
              </div>
              <div className="text-center  py-4 px-[22px] text-xl font-medium rounded-xl bg-[#212F45]">
                <h2 className="text-white">
            ...
            <div className="md:w-[70%] w-[90%] mx-auto mb-14 bg-gray-200 rounded-md dark:bg-gray-700">
              <div
                className="bg-[#0E9219] text-xs font-medium text-blue-100 text-center p-0.2 leading-none rounded-full"
                style={{ width: "45%" }}
              >
                {" "}
                45%
          ...
          <div className="bg-[#212F45] md:w-[70%] mx-auto w-[90%] rounded-md py-7 px-4">
            <h2 className="pt-7 pb-2 text-center font-medium md:text-3xl text-xl text-[#D9D2FF]">
              Current selection
            </h2>
            <div className="">
            ...
            <div className="">
              <div className="min-w-full bg-[#121E2A] rounded-md ">
                ...
                <div className="w-full text-white flex justify-between">
                  ...
                  <div className="px-6 py-4 flex items-center justify-start gap-3">
                    <p>
                      14.12 <span className="text-[#0BDF0E]">0xEthDao</span>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-[#212F45] md:my-14 my-7 md:w-[70%] mx-auto w-[90%] rounded-md py-7 px-4">
            <div className=" text-center ">
              <h2 className="pt-3 pb-2 text-center font-medium md:text-3xl text-xl text-[#D9D2FF]">
                Select your username
              </h2>
              <p
                className="text-md mb-2 font-normal text-[#d9d2ff]"
                style={{
                  textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)",
                }}
              >
                Please select your username, which you can later share with
                friends and earn rewards!
              </p>
              <textarea
                className="w-full text-white my-2 bg-[#121E2A] rounded-md py-4 px-3"
                name=""
                id=""
                cols="60"
                rows="1"
                placeholder="@0xlazytron"
              ></textarea>
            </div>
          </div>
          <div className="bg-[#212F45] md:my-14 my-7 md:w-[70%] mx-auto w-[90%] rounded-md py-7 px-4">
            <div className=" text-center ">
              <h2 className="pt-3 pb-2 text-center font-medium md:text-3xl text-xl text-[#D9D2FF]">
                ...
                <span className="text-[#0BDF0E]">0xEthDao</span> ?
              </h2>
              <p
                className="text-md mb-2 font-normal text-[#d9d2ff]"
                style={{
              ...
              >
                If so, please enter your referrals username below!
              </p>
              <textarea
                className="w-full text-white my-2 bg-[#121E2A] rounded-md py-4 px-3"
                name=""
                ...
                cols="60"
                rows="1"
                placeholder="https://0xethdao.io/ref=?@0xlazytron"
              ></textarea>
            </div>
          </div>
